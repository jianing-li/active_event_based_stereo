...
Download the **_simulated dataset_** on the [dataset project website](https://www.modelscope.cn/datasets/jianingli/RealSense-Event-Sim/files).

RealSense-Event-Sim.zip has been split into three files (i.e., RealSense-Event-Sim.zip.part.aa, RealSense-Event-Sim.zip.part.ab, and RealSense-Event-Sim.zip.part.ac). Please use the cat command to combine them back into a single .zip as follows:

Download the three split simulated files:
```
git clone https://www.modelscope.cn/datasets/jianingli/RealSense-Event-Sim.git
```

Then, please merge the three split files into a single .zip file:
```
cat RealSense-Event-Sim.zip.part.* > RealSense-Event-Sim.zip
```
...
Download the **_real-world dataset_** on the [dataset project website](https://www.modelscope.cn/datasets/jianingli/Active-Event-Stereo/files).

```
git clone https://www.modelscope.cn/datasets/jianingli/Active-Event-Stereo.git
```
